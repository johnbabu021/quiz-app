    ...
    if (item.checked) {
      ...
      if (item.value === options[arrlength[0]].value) {
        ...
        function showRightAnswer() {
          document
            .getElementById(options[arrlength[0]].value + "a")
  ...
  xhttp.onload = function () {
    if (xhttp.status)
      if (xhttp.status === 200) {
        ...
        if (x.results[index].incorrect_answers.length === 3) {
          answers[arrlength[0]].innerHTML = x.results[index].correct_answer;
          answers[arrlength[1]].innerHTML =
            x.results[index].incorrect_answers[0];
          answers[arrlength[2]].innerHTML =
            x.results[index].incorrect_answers[1];
          answers[arrlength[3]].innerHTML =
            x.results[index].incorrect_answers[2];
          question.innerHTML = x.results[index].question;
          correctAnswer = x.results[index].correct_answer;
        } else {
          index++;
